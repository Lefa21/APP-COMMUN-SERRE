                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <select id="typeFilter" class="form-select" onchange="filterActuators()">
                            ...
                            <option value="moteur">Irrigation</option>
                            <option value="led">Éclairage</option>
                        </select>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="row text-center">
                    <div class="col-6">
                        <h4 class="text-success" id="activeCount">
                            <?= count(array_filter($actuators, function ($a) {
                                return $a['etat'];
                            })) ?>
                        </h4>
                        <small>Actifs</small>
        ...
        <div class="modal-content">
            ...
            <form method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="actuatorName" class="form-label">Type de l'actionneur *</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST" id="editActuatorForm">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="editActuatorName" class="form-label">Type de l'actionneur *</label>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li>✅ Actionneurs actifs: <strong><?= count(array_filter($actuators, function ($a) {
                                                                    return $a['etat'];
                                                                })) ?></strong></li>
                            <li>⚡ Actionneurs en marche: <strong id="runningCount"><?= count(array_filter($actuators, function ($a) {
                                                                                        return $a['etat'];
                                                                                    })) ?></strong></li>
                        </ul>
                    </div>
...
<script>
    ...
    /**
 * Envoie une commande manuelle à un actionneur via l'API.
 */
