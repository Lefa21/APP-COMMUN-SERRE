                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div class="flex-grow-1">
                                <h6 class="mb-0"><?= ucfirst($sensor['name']) ?></h6>
                        ...
                        <div class="text-center mb-3">
                            <?php if ($sensor['value'] !== null): ?>
                                <?php if ($sensor['name'] === 'bouton'): ?>
                                    <h3 class="mb-1 <?= $sensor['value'] == 1 ? 'text-success' : 'text-secondary' ?>">
                                        <?= $sensor['value'] == 1 ? 'PRESSÉ' : 'RELÂCHÉ' ?>
                                    </h3>
                                <?php else: ?>
                                    <!-- Affichage normal pour les autres capteurs -->
                                    <h3 class="mb-1">
